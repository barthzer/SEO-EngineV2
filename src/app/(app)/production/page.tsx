  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex items-center justify-between px-1">
        ...
        <span className="rounded-full px-2 py-0.5 text-[11px] font-medium" style={{ color: stage.color, backgroundColor: stage.colorBg }}>
          {articles.length}
        </span>
      </div>
...
function ArticleDrawer({ article: a }: { article: Article }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between">
          <span className="inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-[12px] font-medium" style={{ color: stage.color, backgroundColor: stage.colorBg }}>
            {stage.label}
          </span>
            ...
            {ARTICLES.map((a, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="inline-flex items-center rounded-full px-2.5 py-1 text-[11px] font-medium" style={{ color: stage.color, backgroundColor: stage.colorBg }}>
                    {stage.label}
                  </span>
